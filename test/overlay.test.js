...
test('load fload', function(t) {
	...
	overlay.loadFlood(connections);
	t.ok(overlay.flood[0].substring(0,2) == 'DD');
	t.ok(overlay.flood[1] == localid);
	t.ok(overlay.flood[2].substring(0,2) == '13');
	t.end();
});
