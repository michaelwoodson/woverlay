...
function showStatus() {
	console.log(`Probation: ${serverStatus.probationSocketHolder.sockets.length} Verified: ${serverStatus.verifiedSocketHolder.sockets.length} Promoted: ${promoted} Timed out: ${timedOut}`);
